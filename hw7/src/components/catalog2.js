...
// const PRICES = [52, 53, 55, 67, 69, 94, 23, 45, 52];
...
const catalog = {
    ...
    url: 'https://raw.githubusercontent.com/bakla-zhan/static/master/JSON/catalog2.json',
    init() {
    ...
    _render() {
        ...
        this.items.forEach((item, index) => {
            let imgURL = `${this.imgFTPurl}/product${index + 1}.jpg`;
            let star = '';
                if (index == 1) {
            ...
            <div class="hot-offer">
                <div class="hot-offer__shadow">
                    ...
                    <div class="hot-offer__hover">
                        <div class="hot-offer__square hot-offer__square-product">
                            <button
                                name="add"
